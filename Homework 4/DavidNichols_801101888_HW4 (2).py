...
#David Nichols
#4105 HW 4
#https://github.com/DavidN0809/ECGR-4105/tree/main/Homework%204
#############################################################################
...
#4 the results above are better than homework 3 due to being able to use a non linear kernel
...
#2 The results are better than homework 1 due to SVR taking the weight of each feature into account
...
#3 Poly is best due to higher peaks at 8
...
#Overall Poly was the best with linear right behind it
